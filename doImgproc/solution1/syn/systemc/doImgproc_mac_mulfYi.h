...
#ifndef __doImgproc_mac_mulfYi__HH__
#define __doImgproc_mac_mulfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doImgproc_mac_mulfYi) {
    ...
    SC_CTOR(doImgproc_mac_mulfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
