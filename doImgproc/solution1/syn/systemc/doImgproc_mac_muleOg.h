...
#ifndef __doImgproc_mac_muleOg__HH__
#define __doImgproc_mac_muleOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doImgproc_mac_muleOg) {
    ...
    SC_CTOR(doImgproc_mac_muleOg):  simcore_mac_0_U ("simcore_mac_0_U") {
